# https://github.com/beaunus/stanford-algs/blob/master/testCases/course2/assignment1SCC/TestCaseGenerator.java
...
"""
Example:
    Generate a graph with 20 nodes, containing 2 strongly connected clusters
